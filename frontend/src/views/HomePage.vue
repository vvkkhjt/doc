    ...
    <a-row :gutter="8" class="count-info">
      ...
      <a-col :span="8" class="project-wrapper">
        ...
        <a-carousel effect="fade" style="margin-top: 35px">
          <div style="width: 100%;height: 300px"><img :src="'http://backend.my.org/imagesWeb/1.jpg'" style="width: 100%;height: 100%;object-fit:cover;" /></div>
          <div style="width: 100%;height: 300px"><img :src="'http://backend.my.org/imagesWeb/2.jpg'" style="width: 100%;height: 100%;object-fit:cover;" /></div>
          <div style="width: 100%;height: 300px"><img :src="'http://backend.my.org/imagesWeb/3.jpg'" style="width: 100%;height: 100%;object-fit:cover;" /></div>
        </a-carousel>
      </a-col>
    </a-row>
  </div>
