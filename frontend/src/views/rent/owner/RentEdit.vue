      ...
      <a-row :gutter="20">
        ...
        <a-col :span="24">
          <a-form-item label='房间图片' v-bind="formItemLayout">
            <a-upload
              name="avatar"
              action="http://backend.my.org/file/fileUpload/"
    ...
    imagesInit (images) {
      if (images !== null && images !== '') {
        ...
        images.split(',').forEach((image, index) => {
          imageList.push({uid: index, name: image, status: 'done', url: 'http://backend.my.org/imagesWeb/' + image})
        })
