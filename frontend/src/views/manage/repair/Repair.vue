        ...
        customRender: (text, record, index) => {
          ...
          return <a-popover>
            <template slot="content">
              <a-avatar shape="square" size={132} icon="user" src={ 'http://backend.my.org/imagesWeb/' + record.images.split(',')[0] } />
            </template>
            <a-avatar shape="square" icon="user" src={ 'http://backend.my.org/imagesWeb/' + record.images.split(',')[0] } />
          </a-popover>
        }
      }, {
        title: '维修状态',
