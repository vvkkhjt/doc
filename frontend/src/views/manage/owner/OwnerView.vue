        ...
        <a-col :span="8"><b>业主姓名：</b>
          <a-popover>
            <template slot="content">
              <a-avatar v-if="ownerData.images !== null" shape="square" :size="132" icon="user" :src="'http://backend.my.org/imagesWeb/' + ownerData.images" />
        ...
        <a-col :span="12" v-for="(item, index) in housesList" :key="index">
          <a-card hoverable>
            <img
              ...
              slot="cover"
              alt="example"
              :src="'http://backend.my.org/imagesWeb/' + item.images.split(',')[0]"
            />
